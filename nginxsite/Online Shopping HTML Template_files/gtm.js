...
return null},Wc=!1;if(F.querySelectorAll)try{var Xc=F.querySelectorAll(":root");Xc&&1==Xc.length&&Xc[0]==F.documentElement&&(Wc=!0)}catch(a){}var Tc=Wc;var ld={},md=null,nd=Math.random();ld.s="GTM-PFK425";ld.Ob="783";ld.Md="";var od={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},pd="www.googletagmanager.com/gtm.js";
var qd=pd,rd=null,sd=null,td="//www.googletagmanager.com/a?id="+ld.s+"&cv=53",ud={},vd={},wd=function(){var a=md.sequence||0;md.sequence=a+1;return a};
...
(y("require","ec","ec.js"),B());var Q={hitType:"event",eventCategory:String(e.vtp_eventCategory||f.category),eventAction:String(e.vtp_eventAction||f.action),eventLabel:x(String,e.vtp_eventLabel||f.label),eventValue:x(Ca,e.vtp_eventValue||f.value)};z(L,Q,!1);y("send",Q);}else if("TRACK_SOCIAL"==e.vtp_trackType){}else if("TRACK_TRANSACTION"==e.vtp_trackType){y("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var O=function(N){return Tk("transaction"+N,1)},W=O("Id");y("ecommerce:addTransaction",{id:W,affiliation:O("Affiliation"),revenue:O("Total"),
shipping:O("Shipping"),tax:O("Tax")});for(var ca=O("Products")||[],M=0;M<ca.length;M++){var J=ca[M];y("ecommerce:addItem",{id:W,sku:J.sku,name:J.name,category:J.category,price:J.price,quantity:J.quantity})}y("ecommerce:send");}else if("TRACK_TIMING"==e.vtp_trackType){}else if("DECORATE_LINK"==e.vtp_trackType){}else if("DECORATE_FORM"==e.vtp_trackType){}else if("TRACK_DATA"==e.vtp_trackType){}else{e.vtp_enableEcommerce&&(y("require","ec","ec.js"),B());if(e.vtp_doubleClick||"DISPLAY_FEATURES"==e.vtp_advertisingFeaturesType){var Y="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require","displayfeatures",void 0,{cookieName:Y})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==e.vtp_advertisingFeaturesType){var xa="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
